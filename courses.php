                    ...
                    <div class="content">
                        ...
                        <div class="filter-chips">
                            <div class="chip <?= empty($level_filter) ? 'active' : '' ?>" 
                                 onclick="window.location.href='courses.php'">Semua</div>
                            <div class="chip <?= $level_filter === 'SD' ? 'active' : '' ?>" 
                                 onclick="window.location.href='courses.php?level=SD'">SD</div>
                            <div class="chip <?= $level_filter === 'SMP' ? 'active' : '' ?>" 
                                 onclick="window.location.href='courses.php?level=SMP'">SMP</div>
                            <div class="chip <?= $level_filter === 'SMA' ? 'active' : '' ?>" 
                                 onclick="window.location.href='courses.php?level=SMA'">SMA</div>
                        </div>
